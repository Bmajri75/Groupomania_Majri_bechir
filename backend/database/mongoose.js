...
const paramConnectDb = `mongodb+srv://${process.env.LOGIN_DB}:${process.env.PASSWORD_DB}@cluster0.dayon.mongodb.net/${process.env.NAME_DB}?retryWrites=true&w=majority`;

// Avec la methode connect de mongoose je rentre mes parametre pour la conexion à la Base de donnée.
mongoose
  .connect(`${paramConnectDb}`, {
